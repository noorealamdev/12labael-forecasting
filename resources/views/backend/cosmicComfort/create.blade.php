...
@section('title') {{'Add New Cosmic Comfort'}} @endsection
@section('content')
    @include('backend.partials.alert')

    <!-- Start::page-header -->
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Add New Cosmic Comfort</h1>
    </div>
    <!-- End::page-header -->
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-body add-products p-0">
                    <form action="{{ route('cosmicComfort.store') }}" method="POST">
                        @csrf
                        <div class="p-4">
                            <div class="row gx-5">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="text" class="@error('casestoorder') is-invalid @enderror form-control" name="casestoorder" placeholder="Cases to Order" value="{{ old('casestoorder') }}">
                                                </div>
                                                <div class="col-xl-6">
