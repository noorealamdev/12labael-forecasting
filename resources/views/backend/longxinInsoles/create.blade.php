...
@section('title') {{'Add New Longxin Insole'}} @endsection
@section('content')
    @include('backend.partials.alert')

    <!-- Start::page-header -->
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Add New Longxin Insole</h1>
    </div>
    <!-- End::page-header -->
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-body add-products p-0">
                    <form action="{{ route('longxinInsoles.store') }}" method="POST">
                        @csrf
                        <div class="p-4">
                            <div class="row gx-5">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="text" class="@error('upc') is-invalid @enderror form-control" name="upc" placeholder="UPC" value="{{ old('upc') }}">
                                                </div>
                                                <div class="col-xl-6">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="text" class="@error('fnsku') is-invalid @enderror form-control" name="fnsku" placeholder="FNSKU" value="{{ old('fnsku') }}">
                                                </div>
                                                <div class="col-xl-6">
